    ...
    <div className={styles.container}>
        <div className={styles.slider}>
            <div className={styles.sliderTrack}>
                <OutboundLink className={styles.linkContainer} href="https://html.com/">
                    HTML5
                ...
                <OutboundLink className={styles.linkContainer} href="https://developer.mozilla.org/en-US/docs/Web/CSS">
                    CSS
                ...
                <OutboundLink className={styles.linkContainer} href="https://www.javascript.com/">
                    JavaScript
                ...
                <OutboundLink className={styles.linkContainer} href="https://reactjs.org/">
                    React
                ...
                <OutboundLink className={styles.linkContainer} href="https://www.gatsbyjs.com/">
                    Gatsby
                ...
                <OutboundLink className={styles.linkContainer} href="https://www.netlify.com/">
                    Netlify
                ...
                <OutboundLink className={styles.linkContainer} href="https://github.com/">
                    Github
                ...
                <OutboundLink className={styles.linkContainer} href="https://domains.google/">
                    Google Domains
